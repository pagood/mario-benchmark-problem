package competition.cig.yuxiao.sprites;
...
public class Mario extends competition.cig.yuxiao.sprites.Sprite implements Cloneable
{
    ...
    public competition.cig.yuxiao.sprites.Sprite carried = null;
    ...
    public void move()
    {
        ...
        if (keys[KEY_SPEED] && canShoot && this.fire && world.fireballsOnScreen<2)
        {
            ...
            world.addSprite(new competition.cig.yuxiao.sprites.Fireball(world, x+facing*6, y-20, facing));
        }
    ...
    private boolean isBlocking(float _x, float _y, float xa, float ya)
    {
        ...
        if (((competition.cig.yuxiao.level.Level.TILE_BEHAVIORS[block & 0xff]) & competition.cig.yuxiao.level.Level.BIT_PICKUPABLE) > 0)
        {
            getCoin();
    ...
    public void stomp(competition.cig.yuxiao.sprites.Shell shell)
    {
        if (deathTime > 0 || world.paused) return;
...
//        System.out.println("[die!]");
        ...
        world.paused = true;
        deathTime = 1;
        status = competition.cig.yuxiao.sprites.Mario.STATUS_DEAD;
    }
